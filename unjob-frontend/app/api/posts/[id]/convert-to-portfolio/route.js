// api/posts/[id]/convert-to-portfolio/route.js
  ...
  try {
    ...
    if (existingProjectIndex >= 0) {
      ...
      user.profile.portfolio.push({
        ...
        image: firstPostWithImage?.images || "",
    ...
    // Populate all converted posts
    for (let post of convertedPosts) {
    ...
    console.error("Multiple posts to portfolio conversion error:", error);
    return NextResponse.json(
