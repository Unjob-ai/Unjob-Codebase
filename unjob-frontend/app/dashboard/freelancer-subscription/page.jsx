...
function FreelancerSubscriptionContent() {
    ...
    switch (reason) {
      case "required":
        return {
          ...
          message:
            "An active subscription helps you apply for more premium gigs.",
        };
      case "limit-reached":
        return {
          type: "warning",
          ...
          message:
            "You've reached your monthly application limit. Upgrade to apply for more gigs.",
        };
      case "expired":
        return {
          type: "warning",
          ...
          message:
            "Your subscription has expired. Renew to continue applying for gigs.",
        };
      default:
        return null;
    }
    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center text-center">
        <div>
          ...
          <p className="text-gray-400 mb-6">
            These subscription plans are exclusively for freelancers.
          </p>
          <Button
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400">
                  {currentSubscription.usage.limit === -1
                    ...
                    : `${currentSubscription.usage.remaining} applications remaining`}
                </p>
              </div>
            )}
          </div>
...
export default function FreelancerSubscriptionPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-black text-white flex items-center justify-center">
